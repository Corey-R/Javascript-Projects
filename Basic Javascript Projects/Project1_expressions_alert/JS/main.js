// Creating an alert box with string value
...
// Displaying newly defined variable A into Project 1 document
document.write(A);
...
// Assigning multiple variables within the same statement.
// Note: statements are separate by semicolon(s) ";" and the 
...
// As a side note, methods are pre-made instructions WITHIN AN OBJECT to change the state
// of the SAME OBJECT it's defined in.
