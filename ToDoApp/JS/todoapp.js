...
function get_todos() {
    ...
    var todos = new Array;
    // This pulls the task that was saved in the web browser emory
...
function add() {
    // This takes the inputed task and creates a variable out of it
...
for (var i = 0; i < todos.length; i++) {
    // This also displays the tasks as a list and creates the button with the "x"
...
// NOTE THIS SECTION FOR LATER USE
// This creates the funcitonality of removing a todo item from the array 
function remove() {
